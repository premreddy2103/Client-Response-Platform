  ...
  <div id="header">
    ...
    <div id="topnav">
      ...
      <li><a href="StartUpHome.jsp">Home</a></li>
        <li><a href="PostProducts.jsp">Upload Products</a></li>
  ...
  <div id="homecontent" style="border:none;width:1200px">
    <%String email=(String)session.getAttribute("email");
      ...
      <form action="Postproduct" method="post" enctype="multipart/form-data">
          <center><h2>ALL PRODUCTS WITH RATING</h2>
          <table  style="margin-bottom:250px;">
              ...
              <%
              String query="select * from cart where status1!='waiting'";
              ...
              while(r1.next()){
                 ...
                 int rate=Integer.parseInt(status2);
                  ...
                  String qr="select * from products where id='"+pid+"' and sname='"+name+"'";
