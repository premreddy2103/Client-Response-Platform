  ...
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        ...
        <li><a href="StartupDet.jsp">Startup</a></li>
        <li class="active"><a href="ProductDet.jsp" title="NotSoldProduct">Product All Details</a></li>
...
<div class="wrapper col3">
  <div id="homecontent">
      <h3 style="margin-bottom:20px;">PRODUCT NOT SOLD</h3>
      <table>
          <tr><th>Product ID</th>
              <th>Product Name</th>
              <th>Available Stack</th>
              
          </tr>
      <%Connection con=DBCon.getCon();
      Statement st=con.createStatement();
      ArrayList al=new ArrayList();
      String query="select distinct(productname) from cart where status1='purchased'";
      ResultSet r1=Queries.getExecuteQuery(query);
      while(r1.next()){
          String pname=r1.getString("productname");
          al.add(pname);
      }
      for(int i=0;i<al.size();i++){
          String pname1=(String)al.get(i);
          System.out.println(pname1);
           ResultSet r=st.executeQuery("select * from products where pname!='"+pname1+"'");
      while(r.next()){
          %>
          <tr>
              <td><%=r.getString("id")%></td>
              <td><%=r.getString("pname")%></td>
              <td><font color="red" size="5"><%=r.getString("noofproducts")%></font></td>
          </tr>
          <%
