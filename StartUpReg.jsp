        ...
        <form action="OTCust.jsp" method="post">
          <fieldset>
            ...
            <label for="teachername">Name:
              <input type="text" name="name" id="teachername" value="" required=""/>
            </label>
            <label for="teacherpass">Mobile Number:
              <input type="number" name="mobile" id="teacherpass" value="" required=""/>
            </label>
              <label for="teacherpass">Email ID:
              <input type="email" name="email" id="teacherpass" value="" required=""/>
            </label>
        ...
        <form action="RegularCust.jsp" method="post">
          <fieldset>
            ...
            <label for="pupilname">Email ID:
              <input type="text" name="pupilname" id="pupilname" value="" required=""/>
            </label>
            <label for="pupilpass">Password:
              <input type="password" name="pupilpass" id="pupilpass" value="" required=""/>
            </label>
...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      ...
      <div class="fl_right">
         <form action="StartupREgAction.jsp" method="post">
             <h3>StartUp REGISTER</h3>
             <table>
                 <tr><th>StartUp Name:</th><td><input type="text" name="name" required=""></input></td></tr>
                 <tr><th>StartUp Email</th><td><input type="email" name="email" required=""></input></td></tr>
