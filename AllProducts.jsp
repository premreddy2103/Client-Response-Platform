...
<div class="wrapper col1">
  <div id="header">
    ...
    <div id="topnav">
      <ul>
        <li class="active"><a href="AllProducts.jsp">Home</a></li>
      ...
      <form action="Postproduct" method="post" enctype="multipart/form-data">
          ...
          <table  style="margin-bottom:250px;">
              <tr><th>ID</th><th>Startup Name:</th><th>Category Name</th><th>Sub-Category</th><th>Product Name</th><th>No.Of. Product</th>
                  <th>Product Description</th><th>Date</th><th>Ambassador Image</th><th>Product Image</th><th>AVG Rating</th><th>Add To Cart</th></tr>
              <%
              String query="select * from products order by avgrating desc;";
              ...
              while(r.next()){
                  ...
                  <tr>
                      ...
                      <td><image src="view1.jsp?id=<%=r.getString("id")%>" width="100" height="100"/></td>
                       <td><%=r.getString("avgrating")%></td>
                      <td><a href="CartDB.jsp?id=<%=r.getString("id")%>&pname=<%=r.getString("pname")%>">add</a></td>
                  </tr>      
