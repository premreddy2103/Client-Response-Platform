...
<div class="wrapper col3">
  <div id="homecontent">
      <h3 style="margin-bottom:20px;">PRODUCT HIGH DEMAND</h3>
      <table>
          <tr><th>Product ID</th>
              <th>Product Name</th>
            <th>High Demand</th>  
      ...
      <%
      String query="select distinct(productname) from cart";
      ResultSet r=Queries.getExecuteQuery(query);
      while(r.next()){
          String pname=r.getString("productname");
          ResultSet rr=Queries.getExecuteQuery("select count(productname),productid,productname from cart where productname='"+pname+"' order by productname desc");
      while(rr.next()){    
      %>
          <tr>
              <td><%=rr.getString("productid")%></td>
              <td><%=rr.getString("productname")%></td>
              <td><%=rr.getInt(1)%></td>
